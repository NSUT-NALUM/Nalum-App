...
export type GetCommentVoteGroupByPayload<T extends CommentVoteGroupByArgs> = Prisma.PrismaPromise<
  Array<
...
export type CommentVoteWhereInput = {
  ...
  direction?: Prisma.EnumVoteDirectionFilter<"CommentVote"> | $Enums.VoteDirection
...
export type CommentVoteScalarWhereWithAggregatesInput = {
  ...
  direction?: Prisma.EnumVoteDirectionWithAggregatesFilter<"CommentVote"> | $Enums.VoteDirection
...
export type CommentVoteOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"commentId" | "userId" | "direction" | "createdAt" | "updatedAt", ExtArgs["result"]["commentVote"]>
...
export interface CommentVoteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const commentVoteWithCommentIdOnly = await prisma.commentVote.findMany({ select: { commentId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many CommentVotes and only return the `commentId`
   * const commentVoteWithCommentIdOnly = await prisma.commentVote.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more CommentVotes and only return the `commentId`
   * const commentVoteWithCommentIdOnly = await prisma.commentVote.updateManyAndReturn({
   *   select: { commentId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface CommentVoteFieldRefs {
  ...
  readonly direction: Prisma.FieldRef<"CommentVote", 'VoteDirection'>
