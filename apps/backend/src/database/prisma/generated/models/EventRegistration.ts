...
export type EventRegistrationWhereInput = {
  ...
  userId?: Prisma.UuidFilter<"EventRegistration"> | string
...
export type EventRegistrationScalarWhereWithAggregatesInput = {
  ...
  userId?: Prisma.UuidWithAggregatesFilter<"EventRegistration"> | string
...
export type EventRegistrationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"eventId" | "userId" | "createdAt", ExtArgs["result"]["eventRegistration"]>
...
export interface EventRegistrationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many EventRegistrations and only return the `eventId`
   * const eventRegistrationWithEventIdOnly = await prisma.eventRegistration.createManyAndReturn({
   *   select: { eventId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more EventRegistrations and only return the `eventId`
   * const eventRegistrationWithEventIdOnly = await prisma.eventRegistration.updateManyAndReturn({
   *   select: { eventId: true },
   *   where: {
   *     // ... provide filter here
   *   },
